...
describe('Entities reducer tests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          ...
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PRODUCTCATEGORY),
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_PRODUCTCATEGORY),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_PRODUCTCATEGORY actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PRODUCTCATEGORY),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_PRODUCTCATEGORY),
          payload: resolvedObject,
        },
      ];
