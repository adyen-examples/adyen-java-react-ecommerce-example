...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_PRODUCT),
          REQUEST(ACTION_TYPES.UPDATE_PRODUCT),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PRODUCT),
          REQUEST(ACTION_TYPES.DELETE_PRODUCT),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_PRODUCT),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_PRODUCT actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PRODUCT),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_PRODUCT),
          payload: resolvedObject,
        },
      ];
