...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMERDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CUSTOMERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMERDETAILS actions', async () => {
      const expectedActions = [
        {
