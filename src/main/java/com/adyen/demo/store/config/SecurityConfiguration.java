...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            .headers()
            .contentSecurityPolicy("default-src 'self'; frame-src 'self' data: https://checkoutshopper-test.adyen.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://storage.googleapis.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://checkoutshopper-test.adyen.com; font-src 'self' data:")
        .and()
